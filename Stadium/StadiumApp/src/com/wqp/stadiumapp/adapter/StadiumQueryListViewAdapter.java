...
public class StadiumQueryListViewAdapter extends BaseAdapter {
	...
	public StadiumQueryListViewAdapter(Context context,List<Map<String,Object>> mListViewData,
	...
	private class MyAsyncTask extends AsyncTask<Integer,Integer,Map<String,Object>>{ 
		private static final String TAG = "StadiumQueryListViewAdapter >>> MyAsyncTask"; 
